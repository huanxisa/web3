...
func main() {
	...
	// ========== 静态文件服务 ==========
	// 提供静态文件服务 todo：这个Static方法的作用是什么？介绍一个方法参数以及作用
	r.Static("/static", "./static")

	// 提供文件系统 todo：这个StaticFS方法的作用是什么？介绍一个方法参数以及作用
...
func downloadFile(c *gin.Context) {
	...
	// 检查文件是否存在 todo：为什么文件路径的判断采用err 错误来判断，而不是直接使用os.IsNotExist来判断？这个设计和其他语言不一样
